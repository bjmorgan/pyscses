...
def calculate_grid_offsets_from_sites_data(sites_data: List[SiteData],
                                          x_limits: Tuple[float, float]) -> Tuple[Tuple[float, float], Tuple[float, float]]:
    unique_x_coords = np.unique([sd.x for sd in sites_data])
    print(unique_x_coords)

def calculate_grid_offsets(filename: str,
                           x_min: float,
                           x_max: float,
                           system: str):
